...
function plugin_de_compra_de_ingressos_rodape_function() {
    ...
    $html = '<div class="container-fluid" style="background-image: url(' . $background_url . '); background-size: cover; background-position: center; padding: 5px 20px; font-family: Arial, sans-serif; color: #fff;">';
    $html .= '<div class="row">';
    $html .= '<div class="col-sm-12">';
    $html .= '<h2 style="font-size: 20px; font-weight: bold; margin: 10px;">' . $titulo . '</h2>';
    $html .= '<p style="font-size: 16px; margin: 15px 10px 15px 10px;">' . $data . '</p>';
    $html .= '<a href="' . $url . '" class="btn btn-primary btn-lg" style="background-color: #139DF4; border-color: #139DF4; color: #fff; margin-bottom: 10px; padding: 5px 30px; border-radius: 5px; text-decoration: none;" onmouseover="this.style.backgroundColor=\'#006BBF\'; this.style.borderColor=\'#006BBF\';" onmouseout="this.style.backgroundColor=\'#139DF4\'; this.style.borderColor=\'#139DF4\';">Ingressos</a>';
    $html .= '</div>';
    $html .= '</div>';
    $html .= '</div>';
...
add_shortcode( 'plugin_de_compra_de_ingressos_rodape', 'plugin_de_compra_de_ingressos_rodape_function' );
